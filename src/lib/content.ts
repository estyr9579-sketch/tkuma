...
export const CONTENT: Record<string, ContentField> = {
  ...
  "home.hero.cta": { page: "דף הבית", label: "כפתור ראשי", default: "השארת פרטים" },
  ...
  "process.step3.title": { page: "איך התהליך עובד", label: "שלב 3 – כותרת", default: "טיפול נלווה ותמיכה בוויסות" },
  "process.step3.text": { page: "איך התהליך עובד", label: "שלב 3 – פתיח", default: "במקרים מתאימים, בחינת אפשרויות נוספות שיכולות לתמוך בתהליך המרכזי, לדוגמה:" },
  "process.step3.items": { page: "איך התהליך עובד", label: "שלב 3 – רשימה (שורה לכל פריט)", multiline: true, default: "הידרותרפיה\nרכיבה טיפולית\nטיפול באומנויות\nפעילות גופנית מותאמת\nעיסוי גוף-נפש\nאפשרויות נוספות בהתאם לצורך" },
  "process.step3.note": { page: "איך התהליך עובד", label: "שלב 3 – הבהרה", multiline: true, default: "טיפולים נלווים אינם מתאימים לכל אדם ואינם מהווים תחליף לטיפול רפואי או נפשי כאשר הוא נדרש." },
  "process.step4.title": { page: "איך התהליך עובד", label: "שלב 4 – כותרת", default: "חיבור לאנשי מקצוע" },
  "process.step4.text": { page: "איך התהליך עובד", label: "שלב 4 – טקסט", multiline: true, default: "סיוע באיתור אנשי מקצוע פוטנציאליים שמתאימים לצרכים, למטרות וליכולת הכלכלית.\n\nבמידת האפשר, סיוע ביצירת הקשר ובבניית מעטפת סביב האדם." },
